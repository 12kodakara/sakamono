...
export const productFixtures: Product[] = [
  ...
  {
    id: 'product-lfc-2526-womens-home-replica',
    clubId: 'club-liverpool',
    slug: 'liverpool-2025-26-womens-home-replica',
    name: 'Liverpool FC 2025/26 Home Replica Shirt (Women)',
    nameJa: 'リヴァプール 2025/26 ホーム レプリカ ユニフォーム（ウィメンズ）',
    season: '2025/26',
    manufacturer: 'adidas',
    manufacturerSku: null,
    jan: null,
    ...
    player: null,
    personalization: 'plain',
    image: placeholder('placeholder-kit-home.svg', 'ホームユニフォーム（ウィメンズ）'),
    active: true,
  },
  {
